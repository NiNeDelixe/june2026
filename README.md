<h1 align="center">june2026</h1>
<p align="center"><b><i></i></b></p>
<h1 align="center">
    <a href="%%pakku_url%%/blob/main/LICENSE.md"><img src="https://img.shields.io/github/license/NiNeDelixe/june2026?style=for-the-badge&logo=github" alt="License"></a>
</h1>
...
2. Clone the `june2026` template somewhere, copy over everything but `pakku-lock.json` (and `.gitattributes` and `.git` folder, of course) to your project root.
